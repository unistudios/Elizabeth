...
ADMINS = (
    # ('John Matthew', 'john.matthew@nbcuni.com'),
)
...
DATABASE_HOST = 'usushifldv063.nbcuni.ge.com'             # Set to empty string for localhost. Not used with sqlite3.
...
SECRET_KEY = '%1@6s!g2x%+q2p*a88=8$bw!64oj(k8i%@3^d(x+*a8973ky0='
