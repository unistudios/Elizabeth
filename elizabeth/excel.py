...
def localUsers(request):
    ...
    unix_sysaccts = unixuser.objects.filter(user__type="U", host__retired=False, user__enabled=True, enabled=True)
    win_sysaccts = winuser.objects.filter(user__type="U", host__retired=False, user__enabled=True, enabled=True)
